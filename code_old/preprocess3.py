...
def main():
    ...
    for patient_id in range(len(patients) // 2, len(patients)):
        ...
        pix_resampled, spacing = resample(loaded_patient_pixels, loaded_patient, [1,1,1])
        ...
        segmented_lungs = segmented_lungs.astype(np.int16)
        segmented_lungs_fill = segmented_lungs_fill.astype(np.int16)
        segmented_lungs_fill_dilated = segmented_lungs_fill_dilated.astype(np.int16)

...
def model(input_data, weight_regularizer, is_training, scope='CNN3D', reuse=None):
    with tf.variable_scope(scope, reuse=reuse):
        output = tf.layers.conv3d(input_data, 64, (3, 3, 3), (1, 1, 1), "SAME", name='conv1',
                                  kernel_initializer=scaling_initializer(),
                                  kernel_regularizer=weight_regularizer, activation=tf.nn.relu)
        output = tf.layers.conv3d(output, 64, (3, 3, 3), (1, 1, 1), "SAME", name='conv2',
                                  kernel_initializer=scaling_initializer(),
                                  kernel_regularizer=weight_regularizer, activation=tf.nn.relu)
        output = tf.layers.max_pooling3d(output, (2, 2, 2), (2, 2, 2), "SAME", name='pool2')

        output = tf.layers.conv3d(output, 64, (2, 2, 2), (1, 1, 1), "SAME", name='conv3',
                                  kernel_initializer=scaling_initializer(),
                                  kernel_regularizer=weight_regularizer, activation=tf.nn.relu)
        output = tf.layers.conv3d(output, 64, (2, 2, 2), (1, 1, 1), "SAME", name='conv4',
                                  kernel_initializer=scaling_initializer(),
                                  kernel_regularizer=weight_regularizer, activation=tf.nn.relu)
        output = tf.layers.max_pooling3d(output, (2, 2, 2), (2, 2, 2), "SAME", name='pool4')

        output = tf.layers.conv3d(output, 64, (2, 2, 2), (1, 1, 1), "SAME", name='conv5',
                                  kernel_initializer=scaling_initializer(),
                                  kernel_regularizer=weight_regularizer, activation=tf.nn.relu)
        output = tf.layers.conv3d(output, 64, (2, 2, 2), (1, 1, 1), "SAME", name='conv6',
                                  kernel_initializer=scaling_initializer(),
                                  kernel_regularizer=weight_regularizer, activation=tf.nn.relu)
        ...
        output_final = tf.layers.dense(output, 1, name='dense7',
                                       kernel_initializer=scaling_initializer(),

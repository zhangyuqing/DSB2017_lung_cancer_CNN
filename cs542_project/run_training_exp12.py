...
def model(input_data, kernel_regularizer, is_training, scope='CNN3D', reuse=None):
    with tf.variable_scope(scope, reuse=reuse):
        ...
        output = tf.layers.conv3d(output, 32, (4, 4, 4), (1, 1, 1), "VALID", name='conv2',
                                  kernel_initializer=kernel_initializer,
                                  kernel_regularizer=kernel_regularizer, activation=tf.nn.relu)
        output = tf.layers.max_pooling3d(output, (2, 2, 2), (2, 2, 2), "VALID", name='pool2')

        output = tf.layers.conv3d(output, 48, (2, 2, 2), (1, 1, 1), "VALID", name='conv3',
                                  kernel_initializer=kernel_initializer,
                                  kernel_regularizer=kernel_regularizer, activation=tf.nn.relu)
        output = tf.layers.conv3d(output, 48, (2, 2, 2), (1, 1, 1), "VALID", name='conv4',
                                  kernel_initializer=kernel_initializer,
                                  kernel_regularizer=kernel_regularizer, activation=tf.nn.relu)
        output = tf.layers.max_pooling3d(output, (2, 2, 2), (2, 2, 2), "VALID", name='pool4')

        output = tf.layers.conv3d(output, 64, (2, 2, 2), (1, 1, 1), "VALID", name='conv5',
                                  kernel_initializer=kernel_initializer,
                                  kernel_regularizer=kernel_regularizer, activation=tf.nn.relu)
        output = tf.layers.conv3d(output, 64, (2, 2, 2), (1, 1, 1), "VALID", name='conv6',
                                  kernel_initializer=kernel_initializer,
                                  kernel_regularizer=kernel_regularizer, activation=tf.nn.relu)
